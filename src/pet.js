...
class Pet {
  ...
  growUp() {
    if (!this.isAlive) {
      ...
      this.hunger += 5;
      this.fitness -= 3;
      console.log(`My name is ${this.name}, I am ${this.age += 1} now and I can ${this.sound('Meow')} when I am relaxed. And as i grow older, i feel less fit and hungrier, AND IRRESPECTIVE OF ANY SET LIMITS HERE, I AM HERE TO LIVE LONG!!!`);
    }
  }
